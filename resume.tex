...
\name{Robert}{Hamrick}
% \position{Systems Engineer{\enskip\cdotp\enskip}Developer}
% \position{Systems Engineer{\enskip\cdotp\enskip}Solutions Engineer}
\position{Systems Engineer{\enskip\cdotp\enskip}Operations{\enskip\cdotp\enskip}Glue}
...
\extrainfo{
  \href{https://github.com/hamr/resume/}{\faCodeBranch \texttt{src}} >
