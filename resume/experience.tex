...
%% \begin{cventries}
  ...
  {2024--present}
  {
    ...
    \begin{cvitems2}
    \item Apply wide breadth of skills to integrate 4864 compute nodes, 40 user login nodes, 48 DVS nodes, Lustre (ClusterStor), Ceph (Nexus), Slingshot interconnect, Slurm scheduler, and Kubernetes-based system management (CSM).
    \item Test, integrate, automate, and deploy system software updates on monthly cycle.
    \item Diagnose, work around, and pursue long-term fixes with vendors for system software problems.
    \end{cvitems2}
    \item Responsible for project management tasks for NERSC's next system \textit{Doudna} as a deputy L2 for the \textit{System Installation and Integration} group.
    \end{cvitems}
  }
